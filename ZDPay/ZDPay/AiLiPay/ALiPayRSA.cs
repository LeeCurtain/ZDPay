   ...
   public class ALiPayRSA
    {
        ...
        /// <returns></returns>
        public static string sign(string content, string privateKey, string input_charset, string signType)
        {
            return RSASignCharSet(content, privateKey, input_charset,signType);
        }
        ...
        public static bool RSACheckV1(IDictionary<string, string> parameters, string publicKeyPem, string charset, string signType, bool keyFromFile)
        {
            ...
            string signContent =AliPayHelper.GetSignContent(parameters);
            return AliPayHelper.RSACheckContent(signContent, sign, publicKeyPem, charset, signType, keyFromFile);
        }
